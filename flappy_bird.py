...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("assets/1.png"), pygame.image.load("assets/2.png"), pygame.image.load("assets/dead.png")]
...
def getResult():
    ...
    ft2_surf = pygame.font.SysFont("Arial", 50)             # 设置第二行文字字体
